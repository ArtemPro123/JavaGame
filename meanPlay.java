...
public class meanPlay extends JFrame {
	...
	public meanPlay() {
		...
		label_3.setBounds(551, 37, 93, 39);
		...
		lblNewLabel.setBounds(150, 162, 50, 48);
		...
		button.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				meanPlay.this.dispose();
			}
		});
		button.setForeground(Color.DARK_GRAY);
		button.setFont(new Font("Tahoma", Font.BOLD, 15));
		button.setBounds(298, 405, 105, 20);
		contentPane.add(button);
		
		JLabel lblMean = new JLabel("MEAN", SwingConstants.CENTER);
		...
		lblMean.setBounds(298, 25, 105, 48);
		...
		label_2.setBounds(240, 162, 50, 48);
		...
		label_4.setBounds(329, 162, 50, 48);
		...
		label_5.setBounds(418, 162, 50, 48);
		...
		label_6.setBounds(510, 162, 50, 48);
		contentPane.add(label_6);
		
		JLabel lblWhatIsThe = new JLabel("What is the MEAN?");
		lblWhatIsThe.setFont(new Font("Tahoma", Font.PLAIN, 15));
		lblWhatIsThe.setBounds(150, 273, 143, 17);
		contentPane.add(lblWhatIsThe);
		
		textField = new JTextField();
		textField.setBounds(298, 273, 105, 20);
		...
		btnNewButton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				if(!inputans.equals("")) {
					double inputanss=Double.valueOf(inputans);
					if(answer==inputanss) {
		...
		btnNewButton.setIcon(new ImageIcon(meanPlay.class.getResource("/images/next.PNG")));
		btnNewButton.setBounds(422, 252, 105, 54);
		contentPane.add(btnNewButton);
		
		lblNewLabel_1 = new JLabel("Question: ");
		lblNewLabel_1.setFont(new Font("Tahoma", Font.PLAIN, 14));
		lblNewLabel_1.setBounds(281, 118, 74, 14);
		contentPane.add(lblNewLabel_1);
		
		label_7 = new JLabel("1");
		label_7.setFont(new Font("Tahoma", Font.BOLD, 14));
		label_7.setForeground(Color.DARK_GRAY);
		label_7.setBounds(365, 118, 74, 14);
		...
		btnNewButton_1.setBounds(298, 371, 105, 23);
...
//				         System.out.println("Thread  interrupted.");
	  ...
	  public void generateNumbers() {
		  ...
		  answer=(number1+number2+number3+number4+number5)/5.0;
